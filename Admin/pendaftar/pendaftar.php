...
<input  type="radio" name="prestasi" id="prestasi"  value="Internasional" <?php if($prestasi=="Internasional"){echo"checked";}?>/>Tingkat Internasional <br>
...
<br><br>
<table width="1146" class="table table-bordered table-hover" id="example2">
  	<thead>
  	<tr >
