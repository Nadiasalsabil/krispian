...
<div class="well well-sm">
    <i class="fa fa-twitter" size="24"></i>&nbsp;Data Hasil Pengujian Sentimen Analisis Twitter
</div>
                     ...
                     <table class="table table-striped" id="example1">
                        ...
                        <tbody>
                        <?php  
                           $query = mysqli_query($conn, "SELECT * FROM  `$tbdatauji` where kategori = '1' order by `id_datauji` desc")or die(mysqli_error($conn));
                           $no = 1;        
                           while($data = mysqli_fetch_array($query)){  
                              ...
                              <td> <?php if($data['kategori']==1){
                                echo "Paslon 01 Jokowi dan Ma'ruf Amin";

                              }else{
                                echo "Paslon 02 Prabowo dan Sandi";
                              }?></td>
