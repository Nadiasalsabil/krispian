...
<?php
$edit="SELECT * FROM  `table_datakomen` WHERE no='$_GET[id]'";
...
?>
 ...
 <form action="" method="post" enctype="multipart/form-data">
	<div class="form-group row">
	    <input type="hidden" class="form-control" id="id" name="id" value=<?php echo $data['no']; ?>>
	</div>

    <div class="form-group row">
        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Tweet </label>
            <div class="col-sm-9">
                <textarea class="form-control" id="judul" name="judul" rows="5"><?php echo $data['komentar']; ?></textarea>
                    </div>
                        </div>
...
if (isset($_POST['simpan'])) 
{
    ...
    $bikinos = $initos->createStemmer();
	 ...
	 $update     = "UPDATE table_datakomen SET komentar='$judul',sentimen='$sentimen',stem='$stemming' WHERE no='$id'";
