...
?>
                     ...
                     <table class="table table-striped" id="example1">
                        ...
                        <tbody>
                        <?php  
                           $query = mysqli_query($conn, "SELECT * FROM  `$tbdatauji` order by `id_datauji` asc limit 0,5")or die(mysqli_error());
                           $no = 1;        
...
$sentimen=$max;
$sql="Update `$tbdatauji` set normalisasi='$sentimen',kategori='$kategori',tanggal='$tanggal',flag='1', sentimen='$sentimen'  where `id_datauji`='$id_datauji'";
$up=process($conn,$sql);
