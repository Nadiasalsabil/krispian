...
<html lang="en">
<head>
	<title>Aplikasi Sentimen Analisis</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/capres.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form" method="post">
					<div class="login100-form-avatar">
						<img src="images/loho.png" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						Sistem Sentimen Analisis PILPRES 2019
					</span>
